...
s_nas['MONTH'] = s_nas['MONTH'].replace({'JAN':'January','FEB':'February','MAR':'March','APR':'April','MAY':'May','JUN':'June','JUL':'July','AUG':'August','SEP':'September','OCT':'October','NOV':'November'})
s_nas['CAB'] = s_nas['CAB'].str.split('.').str[-1]
s_nas['SELISIH'] = abs(s_nas['SELISIH'])

oms_nas['MONTH'] = oms_nas['MONTH'].replace({'JAN':'January','FEB':'February','MAR':'March','APR':'April','MAY':'May','JUN':'June','JUL':'July','AUG':'August','SEP':'September','OCT':'October','NOV':'November'})
oms_nas['CAB'] = oms_nas['CAB'].str.split('.').str[-1]
oms_nas['OMSET'] = abs(oms_nas['OMSET'])

cn_nas['MONTH'] = cn_nas['MONTH'].replace({'Jan':'January','Feb':'February','Mar':'March','Apr':'April','Jun':'June','Jul':'July','Aug':'August','Sep':'September','Oct':'October','Nov':'November'})
...
df_pic_oms['MONTH'] = pd.Categorical(df_pic_oms['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
df_pic_oms = df_pic_oms.sort_values('MONTH')

pic['BULAN'] = pd.Categorical(pic['BULAN'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
...
df_pic['MONTH'] = pd.Categorical(df_pic['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
...
df_snas['MONTH'] = pd.Categorical(df_snas['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
...
df_cn['MONTH'] = pd.Categorical(df_cn['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
...
df_cnnas['MONTH'] = pd.Categorical(df_cnnas['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
...
if 'All' in all_cab_selisih:
    df_selisih['MONTH'] = pd.Categorical(df_selisih['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October','November], ordered=True)
