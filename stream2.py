...
styled_pivot_df = df_pic.style.format(lambda x: format_number(x)).apply(highlight_cells, highlight_info=df_pic2.drop(columns=['CAB','NAMA PIC','SELISIH']), axis=None).background_gradient(cmap='Reds', axis=1, subset=df_pic.columns[2:])
