...
s_nas['MONTH'] = s_nas['MONTH'].replace({'JAN':'January','FEB':'February','MAR':'March','APR':'April','MAY':'May','JUN':'June','JUL':'July','AUG':'August','SEP':'September','OCT':'October'})
s_nas['CAB'] = s_nas['CAB'].str.split('.').str[-1]
s_nas['SELISIH'] = abs(s_nas['SELISIH'])

oms_nas['MONTH'] = oms_nas['MONTH'].replace({'JAN':'January','FEB':'February','MAR':'March','APR':'April','MAY':'May','JUN':'June','JUL':'July','AUG':'August','SEP':'September','OCT':'October'})
...
df_pic_oms['MONTH'] = pd.Categorical(df_pic_oms['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October'], ordered=True)
...
gb = GridOptionsBuilder.from_dataframe(styled_pivot_df)
gb.configure_default_column(editable=True)
gb.configure_column("NAMA PIC", pinned="left")  # Freeze Kolom 1
gb.configure_column("CAB", pinned="left")  # Freeze Kolom 2
grid_options = gb.build()

# Menampilkan DataFrame dengan AgGrid
AgGrid(df, gridOptions=grid_options, height=300, width='100%')
...
df_snas['MONTH'] = pd.Categorical(df_snas['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October'], ordered=True)
...
df_cn['MONTH'] = pd.Categorical(df_cn['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October'], ordered=True)
...
df_cnnas['MONTH'] = pd.Categorical(df_cnnas['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October'], ordered=True)
...
if 'All' in all_cab_selisih:
    df_selisih['MONTH'] = pd.Categorical(df_selisih['MONTH'], categories=['January','February','March','April','May','June','July','August','September','October'], ordered=True)
